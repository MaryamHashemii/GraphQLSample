...
public abstract class Hilt_UserFragment<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserFragment(int layoutRes) {
    super(layoutRes);
  }
