...
public abstract class Hilt_MainFragment<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainFragment(int layoutRes) {
    super(layoutRes);
  }
