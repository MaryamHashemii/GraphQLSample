...
public abstract class Hilt_RepositoryFragment<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_RepositoryFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    ((RepositoryFragment_GeneratedInjector) this.generatedComponent()).injectRepositoryFragment(UnsafeCasts.<RepositoryFragment>unsafeCast(this));
  }
